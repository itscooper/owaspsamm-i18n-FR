...
type: stream
url: model/implementation/gestion-des-defauts/stream-b/
business_function: Implémentation
business_function_url: implementation
practice: Gestion des Défauts
practice_url: gestion-des-defauts
stream: B
...
maturity_levels:
    level3:
        ...
        question: Évaluez-vous régulièrement l'efficacité de vos métriques de sécurité afin qu'ils soient toujours pertinents pour contribuer à piloter votre stratégie de sécurité?
        quality_criteria:
            ...
            - Vous avez dérivé au moins une activité stratégique à partir des métriques lors de la dernière année
